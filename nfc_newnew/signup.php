   ...
   <main>
      <div class="auth-card">
         ...
         <div id="formSection">
            ...
            <p class="sub">Already have an account? <a href="customer-login.php">Sign in</a></p>
            ...
            <p class="login-link">Already a member? <a href="customer-login.php">Sign in here</a></p>
         </div>
   ...
   <script>
      ...
      document.getElementById('signupBtn').addEventListener('click', function () {
         ...
         fetch('process_order.php', { method:'POST', body:formData })
            ...
            .catch(function () {
               showAlert('Could not reach the server. Please check your connection and try again.', 'err');
               btn.disabled = false;
               btn.innerHTML = '<i class="fas fa-paper-plane"></i> Create Account & Place Order';
            });
      });
